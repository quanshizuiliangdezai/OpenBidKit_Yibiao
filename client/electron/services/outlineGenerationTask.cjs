...
5.1 所有一级目录标题必须互不相同，不得出现重复标题。标题应使用具体的技术方案名称（例如“网络系统建设方案”“安全防范系统建设方案”“数据中心机房建设方案”），避免使用笼统重复的“实施方案”“技术方案”等泛化表述；当多个技术方向都涉及实施时，必须在标题中明确区分其核心技术领域，绝不允许仅以“实施方案”作为多个一级目录的标题。
...
4.1 所有一级目录标题必须互不相同，不得出现重复标题。标题应使用具体的技术文件/方案名称（例如“技术方案总体设计”“项目实施组织方案”“质量保证体系方案”），避免使用笼统重复的“实施方案”“技术方案”“技术文件”等泛化表述；不同技术方向的一级目录必须在标题中明确区分其核心内容，绝不允许仅以“实施方案”等泛化词作为多个一级目录的标题。
